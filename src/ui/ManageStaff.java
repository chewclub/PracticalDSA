...
public class ManageStaff extends javax.swing.JFrame {
    private StaffTable tableModel2;
    private TableRowSorter<TableModel> sorter;
    /**
     * Creates new form ManageStaff
     */
    private ButtonGroup group;
    ImageIcon boxicon = new ImageIcon(getClass().getResource("/images/boxIcon.png"));
 ...
 private void initTable1(){
    ...
    private void initComponents() {
        ...
        Back.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/bgtitle.fw.png"))); // NOI18N
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(61, 340, 410, 307);
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(490, 340, 140, 220);
        ...
        jButton9.setBounds(63, 299, 100, 23);
        ...
        jButton3.setBounds(430, 110, 90, 30);
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/bgstaff.jpg"))); // NOI18N
        jPanel1.add(jLabel6);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        domain.Staff stf = staff.selectRecord(staffId);

        
            if (stf != null) {
         
               jTextField1.setText(stf.getSName());
               jTextField2.setText(stf.getSPosition());
               jTextField4.setText(String.valueOf(stf.getSContact()));
               jTextField5.setText(stf.getSGender());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        ControlStaff staff = new ControlStaff();
                  ...
                  String staffId="";
                  String latest = staff.getlast();
                  for(int x=1;x<5;x++){
                      staffId += latest.charAt(x);
                  }
                  int stfID = Integer.parseInt(staffId)+1;
                  staffId = "S" + String.format("%d", stfID);
                  
                  JOptionPane.showMessageDialog(null,"    Your new staff ID is "+ staffId +"              " , "New Staff ID", JOptionPane.INFORMATION_MESSAGE, boxicon);
                  ...
                  String combine = head.concat(""+n);
                    if(n+1>=10){
                        ...
                        while(combine.length() != 5){
                            ...
                            head+=n+1;*/
            do{  
                   nameStaff = JOptionPane.showInputDialog("Enter Name :");

                if(nameStaff != null)
                {
                    if(/*nameStaff == null ||*/ nameStaff.isEmpty() || !nameStaff.matches("[A-Z a-z]*")){
    ...
    if(option==0){  //option 0 which is next input dialog
        do{
            option=0;
            pass = JOptionPane.showInputDialog("Enter Password :\nUse At least 3 character ( Max 5 character )");
            
            if(pass!=null){
                    if(pass.length()<3 || pass.length()>5 ||pass.isEmpty()){
                        JOptionPane.showMessageDialog(null, "Password must be in 3 to 5 character !","Invalid Add", JOptionPane.ERROR_MESSAGE);
                        option++;
                    }
                    else{
                        option=2;    
                                        ...
                                        try{
                                            ...
                                            contact = Integer.parseInt(JOptionPane.showInputDialog("Enter Contact :\n <+60>XXXXXXXXX "));
                                                ...
                                                if(String.valueOf(contact).length()>10 || String.valueOf(contact).length()<9){
                                                    ...
                                                    Staff staffperson = new Staff(staffId,nameStaff,pass,gender,post,contact);
                                                    staff.addRecord(staffperson);
...
//}   //big IF
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(jTextField1.getText().equals(stf.getSName())&&jTextField2.getText().equals(stf.getSPosition())&&jTextField4.getText().equals(String.valueOf(stf.getSContact()))&&jTextField5.getText().equals(stf.getSGender())){
        ...
        if(option==2){
            Object[] options2 = {"Yes, edit position","No, remains!"};
            int p = JOptionPane.showOptionDialog(null,"Would you like to "+ "edit the POSITION?","Update Position?",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE,null,options2,options2[1]); 
            ...
            if(p==0){
                ...
                post=stf.getSPosition();
                option=0;
            }
            
        if(option==0){  //option 0 which is next input dialog    
            Object[] options3 = {"Yes, edit password","No, remains!"};
            int q = JOptionPane.showOptionDialog(null,"Would you like to "+ "edit the PASSWORD?","Update Password?",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE,null,options3,options3[1]); 
                ...
                do{
                    option=0;
                        pass=JOptionPane.showInputDialog("Enter Password :\nUse At least 3 character ( Max 5 character )");
                            if(pass!=null){
                                if(pass.length()<3 || pass.length()>5 ||pass.isEmpty()){
                                        JOptionPane.showMessageDialog(null, "Password must be in 3 to 5 character !","Invalid Update", JOptionPane.ERROR_MESSAGE);
                                        option++;
                                }
                                else{
                                        option=2;    
        ...
        if(option==3){    
            ...
            if(s==0){
                ...
                contact=stf.getSContact();
                option=4;
            }
            
             
            if(option==4){ 
               Staff staffperson = new Staff(staffId,name,pass,gender,post,contact);
               staff.updateRecord(staffperson);
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            search.toUpperCase();
            if(!search.equals(""))
            query = "SELECT * FROM STAFF WHERE SID = '"+ search+ "'";
