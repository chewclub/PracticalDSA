...
private ControlSeat SeatC= new ControlSeat();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(ScheduleNo, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTextField4.setText(schedule.getDate1());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int i =JOptionPane.showConfirmDialog(null, "Are you sure want to delete the Schedule?");
        if(i==0){
            Schedule schedule = SecduleC.selectRecord(ScheduleNo.getSelectedItem().toString());
            Seat seat = SeatC.selectRecord(ScheduleNo.getSelectedItem().toString());
            SeatC.deleteRecord(seat);
            SecduleC.deleteRecord(schedule);
